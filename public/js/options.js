$(document).ready(function () {
	...
	$('#add-option').on('click', function()
	{
	    ...
	    n++;
		$('#input_group_'+(n-1)).after('<div id="input_group_'+n+'" class="input-group padding-bottom"><input id="option_'+n+'" name="option_'+n+'" type="text" class="form-control" aria-label="..."><div class="input-group-btn"><a id="remove_option_'+n+'" type="button" class="btn btn-default remove">Eliminar opción</a></div></div>');
	});
